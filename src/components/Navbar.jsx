  ...
  return (
    <nav className="bg-green-700 text-white shadow-md">
      <div className="container mx-auto flex flex-wrap justify-between items-center p-4">
        ...
        {/* Center Links */}
        <div
          className={`flex flex-col md:flex-row gap-4 md:gap-6 md:items-center w-full md:w-auto mt-2 md:mt-0 ${
            open ? "block" : "hidden"
          }`}
        >
          <NavLink
        ...
        {/* Right Section: User Info & Auth */}
        <div
          className={`flex flex-col md:flex-row items-center gap-4 w-full md:w-auto mt-2 md:mt-0 ${
            open ? "block" : "hidden"
          }`}
        >
          {user ? (
            ...
            <div className="flex flex-col md:flex-row md:gap-3 items-center gap-2">
              <NavLink
                to="/auth/login"
                className="bg-white text-green-700 border border-green-600 font-semibold px-4 py-2 rounded-lg shadow-md hover:bg-green-50 transition-all duration-300 text-center"
              >
                Sign In
              </NavLink>
              <NavLink
