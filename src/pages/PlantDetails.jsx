...
//   const [name, setName] = useState(user?.displayName || ""); // logged-in name
//   const [email, setEmail] = useState(user?.email || ""); // logged-in email
...
//         <button onClick={() => navigate("/")} className="px-6 py-3 bg-green-700 text-white rounded-lg hover:bg-green-800 transition-colors">
//           Go Back Home
//         </button>
//       </div>
//     );
...
//     setSuccess(true);
//     setName(user.displayName); // keep logged-in data
//     setEmail(user.email);
//   };
...
//         <img src={plant.image} alt={plant.name} className="w-full md:w-1/2 h-72 md:h-96 object-cover rounded-2xl shadow-lg" />
...
//           </p>
//           <button onClick={() => navigate("/")} className="mt-4 px-6 py-3 bg-green-700 text-white rounded-lg hover:bg-green-800 transition-colors font-semibold">
//             Back to Home
//           </button>
//         </div>
//       </div>
...
//         <h2 className="text-2xl md:text-3xl font-bold text-green-800 text-center">Enroll for {plant.name}</h2>
...
//           <input type="text" placeholder="Your Name" value={name} readOnly className="input w-full border border-gray-300 rounded-lg p-3 bg-gray-100 cursor-not-allowed" />
//           <input type="email" placeholder="Your Email" value={email} readOnly className="input w-full border border-gray-300 rounded-lg p-3 bg-gray-100 cursor-not-allowed" />
//           <button type="submit" className="btn btn-neutral w-full py-3 font-semibold hover:bg-green-700 hover:text-white transition-colors">
//             Enroll Now
//           </button>
//         </form>
//       </div>
